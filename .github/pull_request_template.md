...
- [ ] I have read the [CONTRIBUTING](https://github.com/fabasoad/payaniga-skribidi-scrobbler/blob/main/CONTRIBUTING.md)
doc.
- [ ] Tests for the changes have been added (for bug fixes / features).
- [ ] Docs have been reviewed and added / updated if needed (for bug fixes / features).
- [ ] Installation (`make install`) was run locally and any changes were pushed.
