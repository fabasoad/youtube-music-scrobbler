    ...
    def test_no_env_var(self, monkeypatch: pytest.MonkeyPatch) -> None:
        ...
        tracks = [
            YouTubeMusicTrack(
                ...
                duration="3:00", album="Alb", like_status="INDIFFERENT",
            )
        ]
    ...
    def test_writes_table(
        ...
        tracks = [
            YouTubeMusicTrack(
                ...
                duration="3:30", album="Album", like_status="INDIFFERENT",
                thumbnail="https://example.com/t.jpg",
            ),
            YouTubeMusicTrack(
                video_id="v2", title="No Album", artists=["Artist B"],
                duration=None, album=None, like_status="INDIFFERENT",
            ),
        ]
